...
venue: "Cal State LA"        # brief name of host site without address (e.g., "Euphoric State University")
address: "5151 State Univ. Dr., Los Angeles"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "Mar 23, 2018"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:30-3:00 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2018-03-23      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2018-03023        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["H. Ye"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["R. Vellanoweth"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["hye2@calstatela.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
